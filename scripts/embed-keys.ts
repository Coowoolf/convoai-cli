...
const minimaxGroupId = process.env.CONVOAI_MINIMAX_GROUP_ID;

const keysDir = join(__dirname, '..', 'src', 'keys');
mkdirSync(keysDir, { recursive: true });

if (!qwen || !minimax || !minimaxGroupId) {
  console.error('⚠ Missing CONVOAI_QWEN_KEY, CONVOAI_MINIMAX_KEY, and/or CONVOAI_MINIMAX_GROUP_ID');
...
const keys: Record<string, string> = {
  ...
  minimax_group_id: encrypt(minimaxGroupId),
};
